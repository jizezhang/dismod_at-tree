...
def compare(data, node_list, alpha_true, iota_true, file_path, save_to, cv=0, holdout_nodes=None):
    ...
    return alphas_fit_all, data[['hold_out', 'true_val', 'oracle_avgint', 'bottom_avgint', 'top-bottom_avgint',
                                 'top-bottom2_avgint', 'cascade_avgint', 'cascade-lambda_avgint', 'cascade-skip_avgint']]


def plot_result(results, alphas_fit_all, gamma_list, plot_ranges=None, cv=0, legend_loc=['upper left', 'upper left']):
    # ---- plotting -------
